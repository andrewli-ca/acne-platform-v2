...
export const Route = createFileRoute('/_auth/pokemon')({
  loader: ({ context }) => {
    ...
    context.queryClient.prefetchInfiniteQuery(pokemonInfiniteQueryOptions);
  },
...
function PokemonContent() {
  ...
  const pokemons = data.pages.flatMap((page) => page.pokemon);
  ...
  return (
    <Stack gap="xl">
      ...
      <InfiniteScrollSentinel
        ...
        loadingMessage="Loading more Pokemon..."
      />
    </Stack>
  );
}
